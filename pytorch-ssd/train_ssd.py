...
if __name__ == '__main__':
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            ...
            if(best_loss > (val_loss + val_regression_loss + val_classification_loss)):
                best_loss = val_loss + val_regression_loss + val_classification_loss
                model_path = os.path.join(args.checkpoint_folder, f"{args.net}-bestmodel.pth")
                net.save(model_path)
